...
HRESULT InitDevice()
{
	...
	{
		{ XMFLOAT3(-4.0f, -3.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(-3.0f, -3.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(-1.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(3.0f, -3.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(4.0f, -3.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(2.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 5.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(-1.0f, 5.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(-2.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.0f, 4.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
...
void Render()
{
	...
	XMVECTOR Eye = XMVectorSet(przesuniecieX/100,  2.0f + przesuniecieY/100, 25.0f, 0.0f);
    ...
    // Rotate around the origin
        ...
        g_World2 = XMMatrixRotationY(-1*t) * XMMatrixTranslation(9, 0, 0); //t
